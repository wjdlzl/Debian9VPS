...
echo "   - Squid Proxy	: 8085, 3355 (limit to IP Server)"  | tee -a log-install.txt
...
echo ""
echo "------------------------------ Modified by PhcExic Credits to Sir Wangzki -----------------------------"
